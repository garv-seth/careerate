...
const ScrapedInsights: React.FC<ScrapedInsightsProps> = ({
  ...
  // If no data and still loading, show proper loading state
  if (loading && keyObservations.length === 0 && commonChallenges.length === 0) {
    return (
        ...
        <CardContent className="p-0">
          ...
          <div className="flex items-center justify-center p-8">
            <div className="text-center">
              ...
              <p className="text-sm text-text-secondary">Loading transition insights...</p>
            </div>
          </div>
        </CardContent>
      </Card>
  ...
  // If data is loaded or loading is complete but no data, show content
  return (
    <Card className="card rounded-xl p-6 shadow-glow mb-8">
      <CardContent className="p-0">
        <h2 className="text-xl font-heading font-semibold mb-6">
            ...
            <ul className="space-y-3">
              {keyObservations.length > 0 ? (
                ...
                <li className="flex items-start">
                  ...
                  <p className="text-sm text-text-secondary">
                    No key observations available yet.
                  </p>
                </li>
              )}
            </ul>
            ...
            <ul className="space-y-3">
              {commonChallenges.length > 0 ? (
                ...
                <li className="flex items-start">
                  ...
                  <p className="text-sm text-text-secondary">
                    No common challenges available yet.
                  </p>
                </li>
              )}
            </ul>

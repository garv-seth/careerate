        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-xl text-gray-600 dark:text-gray-300">
              Our AI agents work together to supercharge your career journey
            </p>
          </div>
...
const features = [
  {
    ...
    title: "Cara",
    description: "Orchestration agent that coordinates your personalized career strategy across all AI modules.",
  ...
  },
  {
    ...
    title: "Maya",
    description: "Resume analysis AI that identifies your strengths, gaps, and AI automation risks in your current career path.",
  ...
  },
  {
    ...
    title: "Ellie",
    description: "Industry insights agent that continuously monitors market trends and emerging opportunities in your field.",
  ...
  },
  {
    ...
    title: "Sophia",
    description: "Learning AI that creates personalized skill development roadmaps and recommended resources.",
    bgColor: "bg-primary-100 dark:bg-primary-900/30", 
    textColor: "text-primary-600 dark:text-primary-400"
  }
];
...
const howItWorks = [
  {
    ...
    description: "Maya analyzes your resume to identify strengths, weaknesses, and automation risks.",
    bgColor: "bg-primary-100 dark:bg-primary-900/30",
    textColor: "text-primary-600 dark:text-primary-400",
  ...
  },
  {
    ...
    description: "Ellie monitors market trends to find emerging opportunities aligned with your skills.",
    bgColor: "bg-secondary-100 dark:bg-secondary-900/30",
    textColor: "text-secondary-600 dark:text-secondary-400",
  ...
  },
  {
    ...
    description: "Sophia creates a personalized learning path to help you acquire in-demand skills.",
    bgColor: "bg-accent-100 dark:bg-accent-900/30",
    textColor: "text-accent-600 dark:text-accent-400",
...
const dashboardFeatures = [
  {
    title: "AI Automation Risk Map",
    description: "Visualize which parts of your job are at risk of automation and identify areas for upskilling.",
    bgColor: "bg-primary-500"
  },
  {
    title: "Skill Gap Analysis",
    description: "Detailed breakdown of your current skills vs. market demands with prioritized learning recommendations.",
    bgColor: "bg-secondary-500"
  },
  {
    title: "Career Roadmap",
    description: "Interactive timeline with milestones and action items to achieve your career goals.",
...
const learningRecommendations = [
  {
    ...
    details: "High Impact • 4 week course",
  ...
  },
  {
    ...
    details: "Medium Impact • 2 week course",
